...
const en: Dict = {
  ...
  lockLayout: "Lock layout (tables can't be moved)",
  unlockLayout: "Unlock layout (tables can be moved)",
  searchTable: "Search tables…",
  noResults: "No results",
  focusedTables: "Focused",
  allTables: "All tables",
  addToFocus: "Add to focus",
  removeFromFocus: "Remove from focus",
  zoomPick: "Zoom level (click for presets)",
  crumbIdle: "Move the cursor to a table…",
...
const es: Dict = {
  ...
  toggleFocus: "Alternar modo enfoque",
  focusClearAll: "Quitar todas",
  ...
  lockLayout: "Bloquear layout (las tablas no se pueden mover)",
  unlockLayout: "Desbloquear layout (las tablas se pueden mover)",
  searchTable: "Buscar tablas…",
  noResults: "Sin resultados",
  focusedTables: "Enfocadas",
  allTables: "Todas las tablas",
  addToFocus: "Añadir al enfoque",
  removeFromFocus: "Quitar del enfoque",
  zoomPick: "Nivel de zoom (clic para presets)",
  crumbIdle: "Mueve el cursor a una tabla…",
